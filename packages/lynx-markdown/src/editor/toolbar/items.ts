/**
 * The toolbar item contract is the core's (`@sigx/markdown/editor`):
...
export { defaultToolbarItems, toolbarState } from '@sigx/markdown/editor';
export type { ToolbarItem, ToolbarContext, ToolbarState } from '@sigx/markdown/editor';
