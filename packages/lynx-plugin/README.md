...
7. **Page-config flags.** `LynxTemplatePlugin` emits a fixed key set, but the
   ...
   Because that last sentence has two ways of coming true — the kill switch
