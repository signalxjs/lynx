...
<!-- Auto-generated by sigx prebuild — do not edit manually.
...
export function copyDevClientSources(cwd: string, config: ResolvedConfig, devClientInfo: import('./autolink/android.js').DevClientInfo): void {
    ...
    if (devClientInfo.releaseStubsDir) {
        const stubsRoot = join(pkgDir, devClientInfo.releaseStubsDir);
        if (existsSync(stubsRoot)) {
            ...
            log(`Dev client releaseStubsDir not found: ${stubsRoot}`);
        }
    }
}
