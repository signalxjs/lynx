...
- **Native modules (30+)**: `@sigx/lynx-<capability>` packages (camera, storage, sqlite, location, biometric, notifications, websocket, webview, updates (OTA, + `lynx-updates-ui` prompts), …).
