 ...
 * data keeps rendering after the framework fix. Safe to drop once a
 * store-schema migration normalises legacy entries (or after a major
 * version bump that wipes the persisted state). */
